...
const services = [
  {
    ...
    description:
      "Custom web applications built with modern technologies like React, Node.js, and TypeScript.",
  ...
  },
  {
    ...
    description:
      "Responsive mobile applications that work seamlessly across all devices and platforms.",
  ...
  },
  {
    ...
    description:
      "Robust RESTful APIs and GraphQL endpoints for seamless data integration.",
            ...
            <motion.div
              ...
              <Card className="h-full relative overflow-hidden hover:shadow-2xl transition-all duration-500 bg-card/50 backdrop-blur-sm border border-border/50">
                ...
                <CardHeader className="text-center relative z-10">
                  <div
                    className={`inline-flex p-4 rounded-full bg-gradient-to-br ${service.gradient} mb-4 group-hover:scale-110 transition-transform duration-300`}>
